...
// Decision and the set of Actions an agent can be authorized for. The Authorizer
// port lives in internal/port/outbound; policies live in Casbin (see
// internal/adapter/outbound/casbinauthz), not in the agent table.
package authz
